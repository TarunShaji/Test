...
import { EmailTaskSchema } from '@/lib/db/schemas/email.schema'
...
export async function POST(request) {
    return withAuth(request, async () => {
        ...
        // 2. Schema Validation
        const validation = validateBody(EmailTaskSchema, body)
        ...
        // 3. Engine-Backed Creation (Reusing task lifecycle for consistency)
        ...
        // 4. Persistence
        await database.collection('email_tasks').insertOne(finalTask)
